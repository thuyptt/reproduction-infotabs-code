...
mkdir -p ./../../temp/data/strucpremise
...
mkdir -p ./../../temp/data/parapremiserand
...
mkdir -p ./../../temp/data/strucpremiserand
...
#dummy premise
mkdir -p ./../../temp/data/dummypremise
